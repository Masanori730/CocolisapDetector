      ...
      <div className="fl-page">
        ...
        <div style={{ background:'#fff', border:'1px solid rgba(46,139,74,0.18)', borderRadius:16, padding:'18px 22px', marginBottom:24, position:'relative', zIndex:2, overflow:'hidden', boxShadow:'0 1px 6px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ display:'flex', gap:12, flexWrap:'wrap' }}>
            {[
              { n:1, t:'Choose a mode', d:'Manual lets you input values directly. Smart Location auto-fetches live weather from your selected farm location.' },
              { n:2, t:'Enter farm data', d:'Fill in planting density, total trees, and days without intervention.' },
              { n:3, t:'Get weather (Smart only)', d:'Select your region, province, city, and barangay, then click "Get Weather Data".' },
